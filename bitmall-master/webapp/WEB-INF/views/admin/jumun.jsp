...
<table width="800" border="0" cellspacing="0" cellpadding="0">
	<tr height="40">
		<td align="left"  width="100" valign="bottom">&nbsp 주문수 : <font color="#FF0000">${map.count}</font></td>
...
<table width="800" border="1" cellspacing="0" cellpadding="0" bordercolordark="white" bordercolorlight="black">
	...
	<tr bgcolor="#F2F2F2" height="23">
		...
		<td width="70"  align="center"><a href="${pageContext.servletContext.contextPath }/admin/jumun_info/${list.no}/${list.productName}/${list.num}">${list.no}</a></td>
		<td width="70"  align="center">${list.orderday}</td>
		<td width="250" align="left">&nbsp; ${list.productName}</td>	
		<td width="40" align="center">${list.num }</td>	
		<td width="70"  align="right">${list.totalprice }&nbsp</td>	
		<td width="65"  align="center">${list.orderName }</td>	
		<td width="50"  align="center">${list.pay }</td>	
		<td width="135" align="center" valign="bottom">
			<select name="state" style="font-size:9pt; color:black">
				<option value="1" selected>주문확인</option>
		<!-- 		<option value="2">주문확인</option>
				<option value="3">입금확인</option>
	...
	<!--  		<input type="image" src="${pageContext.servletContext.contextPath }/assets/images/admin/b_edit1.gif" border="0">-->
		...
		<td width="50" align="center" valign="bottom">
			<a href="${pageContext.servletContext.contextPath }/admin/jumun_delete/${list.no}"><img src="${pageContext.servletContext.contextPath }/assets/images/admin/b_delete1.gif" border="0"></a>
		</td>
		</form>
	</tr>
