...
<hr width='900' size='3'>
<form name="form1" method="post" action="${pageContext.servletContext.contextPath }/${authUser.id}/faq">
<table width="600" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
	<tr> 
		...
		<td width="500" height="20"  bgcolor="#F2F2F2">
			&nbsp <input type="text" name="qa_title" value="" size="67">
		</td>
	</tr>
	<tr> 
		<td width="100" height="20" bgcolor="#CCCCCC" align="center">
		...
		<td width="500" height="20" bgcolor="#F2F2F2">
			&nbsp <textarea name="qa_content" rows="7" cols="65"></textarea>
		</td>
	</tr>
</table>
<br>
<table width="600" border="0" cellspacing="0" cellpadding="7">
	<tr> 
		<td align="center">
			...
			<a href="${pageContext.servletContext.contextPath }/${authUser.id}/faq"><input type="button" value="이 전 화 면"></a>
		</td>
	</tr>
</table>
</form>
