...
<table width="800" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
	...
	<tr bgcolor="#F2F2F2" height="23">	
		<td width="100" align="center">${list.cate_no }</td>
		<td width="100" align="center">${list.code }</td>
		<td width="280"	align="center">${list.productName }</td>	
		<td width="70"  align="center">${list.price } &nbsp</td>	
		<td width="50"  align="center">${list.state }</td>	
		<td width="120" align="center">&nbsp ${list.event }</td>	
		<td width="80"  align="center">
			<a href="${pageContext.servletContext.contextPath }/${authUser.id}/product_edit/${list.no}">수정</a>/
			<a href="${pageContext.servletContext.contextPath }/${authUser.id}/${list.no}">삭제</a>
		</td>
	</tr>
	</c:forEach>
</table>
