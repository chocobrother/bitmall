...
<form name="form1" method="post" action="${pageContext.servletContext.contextPath }/${authUser.id}/product_success" enctype="multipart/form-data">
...
>
	...
	<tr> 
		...
		<td width="700" bgcolor="#F2F2F2">
			<b>이미지1</b>: <input type="file" name="image_file" size="30" value="찾아보기"><br>
