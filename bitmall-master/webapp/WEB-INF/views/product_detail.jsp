...
$("#form").attr("action","${pageContext.servletContext.contextPath }/user/cart/${authUser.no}/${vo.no }/${vo.price }/${vo.productName}")	
...
alert("장바구니에 추가되었습니다.");
		...
		.click(
				...
				$("#form").attr("action","${pageContext.servletContext.contextPath }/user/order1")	
...
<!-------------------------------------------------------------------------------------------->	
			...
			<!-- form2 시작  -->
			<form id ="form" name="form2" method="get" action="">
						...
						<table border="0" cellpadding="0" cellspacing="1" width="315" height="315" bgcolor="D4D0C8">
							<tr>
								<td bgcolor="white" align="center">
									<img src="${pageContext.servletContext.contextPath }/${vo.image }" height="315" border="0" align="absmiddle" ONCLICK="Zoomimage('0000')" STYLE="cursor:hand">
								</td>
							</tr>
						</table>
					</td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
							...
							<tr>
								...
								<td style="padding-left:10px">
									<font color="282828">${vo.productName }</font><br>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
							<tr>
								<td height="70" align="center">
									<input id ="btn-order" type ="image" src="${pageContext.servletContext.contextPath }/assets/images/b_order.gif" name="submit" value="submit" align="absmiddle">&nbsp;&nbsp;&nbsp;
									<!--  <a href="${pageContext.servletContext.contextPath }/user/order/${vo.no}"><img src="${pageContext.servletContext.contextPath }/assets/images/b_order.gif" border="0" align="absmiddle"></a>&nbsp;&nbsp;&nbsp;-->
								
								
									<input id = "btn-cart" type ="image" src="${pageContext.servletContext.contextPath }/assets/images/b_cart.gif" name="submit" value="submit" align="absmiddle">&nbsp;&nbsp;&nbsp;
								<!-- 	<a href="${pageContext.servletContext.contextPath }/user/cart/${authUser.no}"><img src="${pageContext.servletContext.contextPath }/assets/images/b_cart.gif"  border="0" align="absmiddle"></a> -->
								</td>
							</tr>
						</table>
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="746" style="font-size:9pt">
				...
				<tr>
					<td height="200" valign=top style="line-height:14pt">
						...
						<br>
						<center>
							<img src="${pageContext.servletContext.contextPath }/${vo.image}"><br><br><br>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="746">
				<tr>
					<td align="center" class="cmfont">배송은 걸어서 가져다 드립니다.</td>
				</tr>
			</table>
			<table border="0" cellpadding="0" cellspacing="0" width="746" class="cmfont">
				<tr><td height="10"></td></tr>
