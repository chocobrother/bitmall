								...
								<td align="center">
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										<tr>
											...
											<td>
												<input type="text" name="id" maxlength = "12" value="${authUser.id }" size="20" class="cmfont1"> 
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										...
										<tr>
											...
											<td>
												<input type="text" name='birth' size = "15" maxlength = "15" value = "${authUser.birth}" class="cmfont1"> <font color="898989"></font> 
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										<tr>
											...
											<td>
												<input type="text" name='tel' size = "15" maxlength = "15" value = "${authUser.tel }" class="cmfont1"><font color="898989">-</font>
										...
										<tr>
											...
											<td>
												<input type="text" name='phone' size = "15" maxlength = "15" value = "${authUser.phone}" class="cmfont1"><font color="898989">-</font>
										...
										<tr>
											...
											<td>
												<input type="text" name='zip' size = "10" maxlength = "10" value = "" class="cmfont1"><font color="898989">-</font>
												...
												<input type="text" name='addr' size = "50" maxlength = "200" value = "${authUser.addr }" class="cmfont1"><br>
											</td>
										</tr>
										<tr>
											<td width="127" height="30">
