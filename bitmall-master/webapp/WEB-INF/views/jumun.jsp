...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="685" class="cmfont">
				...
				<tr>
					<td height="30" align="center"><font color="686868">${list.orderday }</font></td>
					<td align="center">
						<a href="${pageContext.servletContext.contextPath }/user/jumun_info/${list.no}/${list.productName }/${list.product_no}/${list.num}"><font color="#0066CC">${list.no }</font></a>
					</td>
					<td align="center"><font color="686868">${list.productName }</font></td>
					<td align="right"><font color="686868">${ list.totalprice } 원</font></td>
					<td align="center"><font color="#0066CC">주문완료</font></td>
				</tr>
