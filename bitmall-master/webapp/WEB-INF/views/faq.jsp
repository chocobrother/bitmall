...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690" class="cmfont">
				...
				<tr height="25" bgcolor="#FFFFFF">	
					<td width="90" align="center"><font color="#686868">${count-status.index}</font></td>	
					<td><a href="${pageContext.servletContext.contextPath }/user/faq_read/${list.no}"><font color="#686868">${list.qa_title}</font></a></td>	
				</tr>
				</c:forEach>
