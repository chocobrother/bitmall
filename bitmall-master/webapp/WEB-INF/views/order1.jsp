...
<!-------------------------------------------------------------------------------------------->	
			...
			<!-- form2 시작  -->
			<form name="form2" method="post" action="${pageContext.servletContext.contextPath }/user/order_pay1">
			
			<input type = "hidden" name="no" value ="${map.productvo.no }"/>
			<input type = "hidden" name="num" value ="${map.productvo.num }"/>
